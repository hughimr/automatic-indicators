...
where ds between '${sdate}' and '${edate}'
    ...
    and key like 'PageLoad_%'
group by ds
;"|awk -F '\t' -v to=${today} '{print "D",$1,"kdb","kdb_daily_pv_device",to,$2;print "D",$1,"kdb","kdb_daily_uv_device",to,$3;print "D",$1,"kdb","kdb_daily_pv_pid",to,$4;print "D",$1,"kdb","kdb_daily_uv_pid",to,$5;}' OFS='\t'>${tempfile}
